...
import net.vmyun.shouhuoji.dao.UserDao;
import net.vmyun.entity.Role;
import net.vmyun.entity.User;
import net.vmyun.shouhuoji.service.UserService;
...
public class UserServiceImpl extends ServiceImpl<UserDao, User> implements UserService {
	 ...
	 * @see net.vmyun.client.service.UserService#findUserByLoginName(java.lang.String)
	 */
