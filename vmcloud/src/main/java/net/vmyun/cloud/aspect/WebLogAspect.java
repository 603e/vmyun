package net.vmyun.cloud.aspect;

import com.alibaba.fastjson.JSONObject;
import net.vmyun.cloud.base.MySysUser;
import net.vmyun.cloud.entity.Log;
import net.vmyun.cloud.exception.GlobalExceptionHandler;
...
public class WebLogAspect {
    ...
    @Pointcut("@annotation(net.vmyun.annotation.SysLog)")
    public void webLog(){}
