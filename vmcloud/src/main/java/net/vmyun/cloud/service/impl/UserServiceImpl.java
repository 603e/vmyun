...
import net.vmyun.cloud.dao.UserDao;
import net.vmyun.entity.Role;
import net.vmyun.entity.User;
import net.vmyun.cloud.service.UserService;
...
public class UserServiceImpl extends ServiceImpl<UserDao, User> implements UserService {
	 ...
	 * @see net.vmyun.cloud.service.UserService#findUserByLoginName(java.lang.String)
	 */
